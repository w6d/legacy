...
public class DemoRootPane extends JRootPane implements HyperlinkListener, SyntaxConstants {
	...
	private void addItem(String name, String res, String style, ButtonGroup bg, JMenu menu) {
	...
	private RSyntaxTextArea createTextArea() {
		...
		try {
			SyntaxScheme scheme = SyntaxScheme.load(textArea.getFont(), new java.io.FileInputStream("D:/temp/eclipse.xml"));
	...
	private class AboutAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(DemoRootPane.this, "<html><b>RSyntaxTextArea</b> - A Swing syntax highlighting text component" + "<br>Version 1.3" + "<br>Licensed under the LGPL", "About RSyntaxTextArea", JOptionPane.INFORMATION_MESSAGE);
		}
